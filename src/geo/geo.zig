//! Integer computational geometry for the cross-band composition redesign
//! (specs/cross-band-composition-redesign.md). Phase 0 — the geometry core, not
//! yet wired to the baker, the live oracle, or the client:
//!
//!   * `boolean` — a Martinez–Rueda–Feito polygon boolean (union / intersection /
//!     difference / symmetric-difference) on the integer lattice, with
